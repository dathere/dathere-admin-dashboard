...
//   // Dataset management
//   const [groupDatasets, setGroupDatasets] = useState<Dataset[]>([]);
...
//     try {
//       const response = await fetch(`/api/ckan/group_show?id=${groupName}&include_datasets=true`);
...
//         });
//         setCurrentImage(group.image_url || null);
//         setGroupDatasets(group.packages || []);
//       } else {
...
//     try {
//       const response = await fetch('/api/ckan/member_create', {
//         method: 'POST',
...
//       if (data.success) {
//         toast.success('Dataset added to group');
//         fetchGroup(); // Refresh group datasets
...
//     try {
//       const response = await fetch('/api/ckan/member_delete', {
//         method: 'POST',
//         headers: { 'Content-Type': 'application/json' },
//         body: JSON.stringify({
//           id: formData.id,
...
//       if (data.success) {
//         toast.success('Dataset removed from group');
//         fetchGroup(); // Refresh group datasets
//       } else {
...
//       const updateResponse = await fetch('/api/ckan/group_patch', {
//         method: 'POST',
//         headers: { 'Content-Type': 'application/json' },
...
//         throw new Error(updateData.error?.message || 'Failed to update group');
//       }
...
//     !groupDatasets.find(gd => gd.id === dataset.id) &&
...
//               <h2 className="text-xl font-semibold">Datasets in this Group</h2>
//               <button
//                 type="button"
...
//                       {datasetSearch ? 'No datasets found' : 'All datasets already added'}
//                     </p>
//                   ) : (
...
//                 No datasets in this group yet. Click "Add Dataset" to add some.
//               </p>
//             ) : (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 space-y-6">
                <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Group Information</h2>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Datasets in this Group</h2>
                  <button
                    type="button"
                    onClick={() => setShowAddDataset(!showAddDataset)}
              ...
              <div className="flex gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <Link
                  href="/groups"
                  className="px-6 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 rounded-lg text-gray-900 dark:text-white"
                >
                  Cancel
                </Link>
              </div>
